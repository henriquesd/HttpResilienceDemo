# HttpResilienceDemo
A .NET 10 Web API solution demonstrating practical examples for the article series **"Building a Resilient .NET Web API."**  

## Articles:
- [Part 1 - Introduction To Resilience](https://henriquesd.com/articles/building-a-resilient-net-web-api-part-1)
- [Part 2 - Retry Strategy](https://henriquesd.com/articles/building-a-resilient-net-web-api-part-2)
